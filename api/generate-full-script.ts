...
2. **芸能人・タレント・有名人の名前（超重要！）**：
   タレント名は特に誤読が多いため、以下の例を参考にカタカナ/ひらがなで書いてください。
...
**ポイント**: タレント名が投稿に出てきたら、必ずひらがな/カタカナで読みやすく変換してください。
