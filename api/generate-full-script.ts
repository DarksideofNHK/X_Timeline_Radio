...
**ユーザー名は原則カタカナに変換して読みやすくする！**

**変換ルール：**
- アルファベットのユーザー名はカタカナ読みに変換
- アンダースコア「_」やハイフン「-」は無視して連結
- 数字はそのまま読む（例：123→いちにさん）

**変換例：**
- ✅「DEATHDOL_NOTE」→「デスドルノートさん」
- ✅「narumi」→「ナルミさん」
- ✅「usadapekora」→「ウサダペコラさん」
- ✅「tech_news_jp」→「テックニュースジェーピーさん」
- ✅「user123」→「ユーザーいちにさんさん」

**禁止事項：**
- ❌「DEATHDOL_NOTEさん」（アルファベットのまま）
- ❌「narumi さん」（スペースあり）
- ❌「@usadapekora さん」（@マーク付き）
