...
${hasAnyPosts ? `
2. **速報コーナー**（60-90秒）★オープニング直後に配置★【コンパクト・公式優先】
   - 「まず、緊急性の高い速報からお伝えします」
   - **★公的アカウントを優先★**：気象庁、自治体、NHK、消防、警察などの公式情報を最優先
   - 一般ユーザーの投稿は補足程度に（公式情報がない場合のみ詳しく）
   - **★コンパクトに概略だけ★**：個別投稿の全文読み上げは避け、要点をまとめて伝える
   - 例：「気象庁によると、○○に警報が発表されました。また△△では震度3を観測しています」
   - 詳細は後続のコーナーで紹介するため、ここでは全体像を素早く伝える
...
\`\`\`json
{
  "sections": [
    ...
    },
    {
      ...
      "genre": "breaking",
      "title": "速報",
      "script": "まず、緊急性の高い速報からお伝えします。気象庁によると、いしかわ県のとおり地方に大雨警報が発表されています。また午後2時15分ごろ、にいがた県で震度3を観測しました。詳しい状況はこの後お伝えします。",
    ...
    },
    {
      ...
      "genre": "damage",
      "title": "その他被害情報",
      "script": "その他の被害情報です。さいたま市で住宅火災が発生しています。消防によると、午前10時ごろ出火し、いま現在も消火活動が続いているとのことです。現地のスズキさんの投稿です。『近所で火事。消防車が5台くらい来てる。煙がすごい』　現場の緊迫した状況が伝わってきます。",
      "estimatedDuration": 150
    },
    {
      "id": "preparedness",
