...
- ✅ 正しい例：「続いては narumi さんの投稿です」「usadapekora さんからの投稿」
- ❌ 間違い例：「アット narumi さん」「@usadapekora さん」
- ユーザー名はそのままアルファベットで出力し、「さん」をつける
...
5. **数字・日付**：
   - 年は「にせんにじゅうろくねん」ではなく「2026年」とそのまま書く（TTSが正しく読む）
   - 日付は「1月3日」のように漢数字を使わない

**重要**: 読み仮名を追加する場合は、元の表記を削除してひらがな/カタカナのみにすること。
...
\`\`\`json
{
  "sections": [
    ...
    },
    {
      ...
      "genre": "entertainment",
      "title": "🎬 エンタメ",
      "script": "エンタメコーナーです。今日は新年ということもあり、VTuberや声優さんからの新年挨拶や、プレゼントキャンペーンの投稿が目立ちますね。では早速見ていきましょう。まずはプレゼントキャンペーンから。nitamusement777 さんの投稿です。「新年プレゼントキャンペーン第三弾...」実機プレゼントは夢がありますね。同じくキャンペーン系で、RC_REJECT さんの投稿です。「いつもリジェクトを応援してくださるファンの皆様...」豪華なプレゼントですね。続いて新年挨拶に移りましょう。usadapekora さんの投稿です。「新春三期生24時間配信、完走...」完走お疲れ様でした。以上、エンタメコーナーでした。",
